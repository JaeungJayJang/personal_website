...
const About = () => {
    ...
    return (
        ...
        //                 <div className="flex flex-col bg-primary px-4 lg:px-8 py-8 lg:py-16 space-y-3 justify-items-stretch">
        ...
        //                     </div>
        //                     <div className="">
        //                         <h1 className="text-5xl leading-normal font-bold text-secondary">
        //                             Jaeung Jang
        //                         </h1>
        //                     </div>
